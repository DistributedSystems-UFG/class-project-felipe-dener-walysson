...
class IoTServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.LightStatus = channel.unary_unary(
                '/iot_service.IoTService/LightStatus',
                request_serializer=iot__service__pb2.LedStatusRequest.SerializeToString,
                response_deserializer=iot__service__pb2.LedStatusResponse.FromString,
                )
...
def add_IoTServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'LightStatus': grpc.unary_unary_rpc_method_handler(
                    servicer.LightStatus,
                    request_deserializer=iot__service__pb2.LedStatusRequest.FromString,
                    response_serializer=iot__service__pb2.LedStatusResponse.SerializeToString,
            ),
    }
...
class IoTService(object):
    ...
    def LightStatus(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/iot_service.IoTService/LightStatus',
            iot__service__pb2.LedStatusRequest.SerializeToString,
            iot__service__pb2.LedStatusResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
